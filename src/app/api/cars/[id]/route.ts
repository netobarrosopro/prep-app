...
// Atualiza o cadastro do carro — SOMENTE o dono pode editar os dados
// do carro (o preparador registra apenas as modificações).
async function handlePATCH(req: NextRequest, { params }: Params) {
  ...
  if (!access.isOwner) {
    return NextResponse.json(
      { error: "Somente o dono do carro pode editar os dados do cadastro." },
      { status: 403 }
    );
  }
